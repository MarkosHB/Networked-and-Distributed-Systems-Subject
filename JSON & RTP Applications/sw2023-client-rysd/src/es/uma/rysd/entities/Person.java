...
// Clase obtenida cuando se consulta la informaci�n de un personaje
...
public class Person {
	...
	// Todos los atributos anteriores se obten�an directamente del objeto devuelto por la consulta
